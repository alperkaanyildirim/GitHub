...
SELECT hc."HastaMerkezId", 
	   ...
	   COUNT( DISTINCT case WHEN DBolum."BolumAdi" not like  '%Laboratuvar%' and DBolum."BolumAdi" not like  '%Radyoloji%' and cast (fp."IslemTarihi" as date) between T."UcAyOnceIlkGun" and T."OncekiAySonGun" THEN FP."ProtokolId" END ) AS "Adet_03", 
	   COUNT( DISTINCT case WHEN DBolum."BolumAdi" not like  '%Laboratuvar%' and DBolum."BolumAdi" not like  '%Radyoloji%' and cast (fp."IslemTarihi" as date) between T."AltiAyOnceIlkGun" and T."OncekiAySonGun" THEN FP."ProtokolId" END ) AS "Adet_06", 
	   COUNT( DISTINCT case WHEN DBolum."BolumAdi" not like  '%Laboratuvar%' and DBolum."BolumAdi" not like  '%Radyoloji%' and cast (fp."IslemTarihi" as date) between T."OnIkiAyOnceIlkGun" and T."OncekiAySonGun" THEN FP."ProtokolId" END ) AS "Adet_012", 
	   COUNT( DISTINCT case WHEN DBolum."BolumAdi" not like  '%Laboratuvar%' and DBolum."BolumAdi" not like  '%Radyoloji%' and cast (fp."IslemTarihi" as date) between T."YirmiDortAyOnceIlkGun" and T."OncekiAySonGun" THEN FP."ProtokolId" END ) AS "Adet_024", 
...
SELECT HC."HastaMerkezId", 
	   ...
	   count ( distinct CASE WHEN DBolum."BolumAdi" not like  '%Laboratuvar%' and DBolum."BolumAdi" not like  '%Radyoloji%' and cast (FP."IslemTarihi" AS date) <= T."OncekiAySonGun" THEN FP."ProtokolId" END ) AS "Frekans", 
	   cast (now() AS timestamp) AS "ETLDate" 
FROM "FCTProtokol" FP
LEFT JOIN "MEMOBI_DWH"."DIMHastaCurrent" HC on HC."HastaId" = FP."HastaMerkezId" 
LEFT JOIN "MEMOBI_ODS_MRKZ"."Ortak_Hizmet" OH ON OH."Id" = FP."HizmetId" 
